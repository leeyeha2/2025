...
# --- 앱의 제목 및 설명 ---
st.title("🌿 마음을 보듬는 곳, 하룰랄라 고민 상담소")
st.markdown("언제든 찾아와 당신의 이야기를 들려주세요. 하룰랄라가 따뜻한 조언으로 당신의 마음을 보듬어 드릴게요.")
        ...
        if st.button("따뜻한 조언 받기"):
            if user_worry and len(user_worry) >= 20: # 최소 글자 수 제한
                ...
                if category == '학업':
                    ...
                    점수나 결과에 너무 얽매이지 마세요. 중요한 것은 어제보다 조금 더 성장한 오늘, 그리고 그 작은 노력들이 모여 만들어낼 내일이에요. 잠시 쉬어가며 마음의 여유를 찾는 것도 중요합니다. 스스로에게 '이만하면 잘했어!'라고 따뜻하게 말해주세요. 당신의 노력과 인내는 분명 아름다운 결실을 맺을 거예요. 하룰랄라가 언제나 당신의 길을 응원할게요.
                    """
                elif category == '진로':
                    counseling_message = """
                    ...
                    조급해하지 마세요. 다양한 경험을 통해 당신의 마음이 이끌리는 곳이 어디인지, 무엇을 할 때 가장 빛나는지 탐색해보세요. 실패를 두려워하지 않는 용기, 그리고 나를 믿는 굳건한 마음만 있다면 분명 당신만의 특별한 길을 찾을 수 있을 거예요. 당신의 빛나는 미래를 하룰랄라가 진심으로 응원합니다.
                    """
                elif category == '가족':
                    counseling_message = """
                    ...
                    하지만 가족은 우리 삶의 가장 소중한 울타리이자 근원적인 사랑의 공간이랍니다. 잠시 시간을 내어 서로의 이야기를 들어주고, 진심으로 이해하려는 노력을 해보는 것은 어떨까요? 따뜻한 대화와 작은 배려가 얼어붙었던 마음을 녹여줄 수도 있어요. 당신의 소중한 가족에게 평화와 사랑이 가득하기를 하룰랄라가 마음 다해 기도합니다. 당신도 충분히 노력하고 있으니 너무 자책하지 마세요.
                    """
                elif category == '연애':
                    counseling_message = """
                    설레는 당신, 연애 때문에 고민하고 계시군요. 사랑은 우리를 행복하게도 하지만, 때로는 큰 아픔과 고민을 안겨주기도 해요. 상대방의 마음을 이해하기 어렵거나, 내 마음을 어떻게 표현해야 할지 몰라 답답할 수도 있겠네요.

                    가장 중요한 것은 바로 '당신 자신'입니다. 스스로를 사랑하고 소중히 여길 때, 비로소 건강하고 아름다운 관계를 만들 수 있어요. 상대방과 솔직하고 열린 마음으로 대화하며 서로의 감정을 나누고, 작은 순간들을 소중히 여겨보세요. 관계는 두 사람이 함께 가꾸어 나가는 정원과 같으니까요. 지금 이 고민의 시간이 더 깊은 사랑으로 가는 밑거름이 될 거예요. 당신의 사랑이 늘 행복하기를 하룰랄라가 빌어줄게요.
                    """
                elif category == '직장':
                    counseling_message = """
                    ...
                    잠시 멈춰 서서 자신을 돌보는 시간을 가져보세요. 스트레스를 해소할 나만의 방법은 무엇인지 찾아보고, 가능하다면 신뢰하는 동료나 선배와 터놓고 이야기해보는 것도 큰 힘이 될 수 있어요. 모든 것을 완벽하게 하려 하지 않아도 괜찮아요. 당신의 건강과 행복이 가장 중요합니다. 하룰랄라는 당신이 직장에서 더욱 빛날 수 있도록 언제나 응원할게요.
                    """
                elif category == '인간관계':
                    counseling_message = """
                    ...
                    모든 사람과 완벽하게 잘 지낼 수는 없다는 것을 기억해주세요. 당신의 소중한 에너지를 빼앗아가는 관계보다는, 당신을 진심으로 이해하고 지지해주는 관계에 더 집중하는 것이 중요해요. 스스로를 존중하고 건강한 경계를 설정하는 것이 행복한 관계의 시작이랍니다. 당신의 마음을 편안하게 해주는 소중한 인연들이 가득하기를 하룰랄라가 진심으로 바랍니다.
                    """
                else: # 기타
                    counseling_message = """
                    ...
                    때로는 전문가의 도움을 받는 것도 아주 현명한 선택입니다. 당신은 혼자가 아니며, 주변에는 당신을 아끼고 지지하는 많은 이들이 있다는 것을 잊지 마세요. 이 힘든 시간이 당신을 더욱 단단하고 지혜롭게 만들 것이라고 믿어요. 하룰랄라는 언제나 당신의 옆에서 응원의 메시지를 보낼 거예요. 힘내세요!
                    """
                st.info(f"**하룰랄라가 당신께 드리는 조언입니다.**\n\n{counseling_message}") # 깔끔한 파란색 박스 안에 조언 표시
                st.markdown("---")
                ...
                st.warning("당신의 소중한 고민 내용을 최소 20자 이상 작성해주셔야 하룰랄라가 더 깊이 있는 조언을 해드릴 수 있어요! 다시 한번 확인해주세요.")
else:
    st.info("먼저 고민의 종류를 선택해주세요. 위에서 목록을 눌러 선택하실 수 있습니다. 천천히 골라보세요.")
